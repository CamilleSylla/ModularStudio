...
export default function Template () {
  ...
  const data = {
    ...
    illustration : {
      laptop : "/assets/img/desktop.png",
      phone : "/assets/img/phone.png",
      tablette : "/assets/img/tablette.png"
    }
  }
    ...
    <div>
      <Head>
        ...
        <link rel="icon" href="/favicon.ico" />
                                                                                            ...
                                                                                            {/* Total width = 100+100+50+100+50+100*/}
      <main ref={mainRef} style={{scrollBehavior: "none",display: "flex",flexWrap: "nowrap",width: "500vw", overflowX: "hidden", overflowY: "hidden"}}>
        <Banner title={data.template_name} background={data.template_banner_img} label={data.template_owner_target}/>
        <Presentation presentation={data.presentation} illustration={data.illustration}/>
        <ImgSeperator img={data.seperator}/>
        <Presentation presentation={data.presentation} illustration={data.illustration}/>
        <ImgSeperator img="https://images.unsplash.com/photo-1626036938027-aafe35e3e479?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=880&q=80"/>
        <Presentation presentation={data.presentation} illustration={data.illustration}/>
